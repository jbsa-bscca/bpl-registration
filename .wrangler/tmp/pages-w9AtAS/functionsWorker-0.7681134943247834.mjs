...
async function onRequestPost(context) {
  ...
  try {
    ...
    const battingRole = formData.get("battingRole");
    const bowlingRole = formData.get("bowlingRole");
    ...
    const caption = `\u{1F3CF} *New Registration* \u{1F3CF}

\u{1F464} *Name:* ${playerName}
\u{1F4DE} *Contact:* ${contactNumber}
\u{1F3E1} *Village/Team:* ${villageName}
\u{1F3AF} *Role:* ${playerRole}
\u{1F3CF} *Batting:* ${battingRole}
\u{1F3B3} *Bowling:* ${bowlingRole}
...
Please find the player photo attached.`;
    ...
    const paymentCaption = `\u{1F4B0} *Payment Screenshot* for ${playerName}`;
...
// ../.wrangler/tmp/pages-w9AtAS/functionsRoutes-0.24476103958545248.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-t5KP8X/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-t5KP8X/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7681134943247834.mjs.map
